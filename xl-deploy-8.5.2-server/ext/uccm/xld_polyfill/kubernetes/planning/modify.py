...
from xld.kubernetes.resource.planningScripts.generator import ModifyPlanGenerator
...
if deployed.type != 'openshift.TemplateResources':
    ...
    plan_generator = ModifyPlanGenerator(previousDeployed, deployed, steps_generator)
    plan_generator.__resource_helper = ProfileResourceHelper(deployed, deployedApplication.environment)
    plan_generator.__previous_resource_helper = ProfileResourceHelper(previousDeployed, previousDeployedApplication.environment)
